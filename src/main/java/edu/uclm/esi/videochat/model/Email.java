...
public class Email {
	...
	public void send(String destinatario, String subject, String body) {
		...
		String port="587";
		String sender="monica.romero2@alu.uclm.es";		// REMITENTE
		String serverUser="monica.romero2@alu.uclm.es";	// USUARIO
		String userAutentication= "true";
		String pwd="Mama10031969";				// PONER LA CONTRASEÑA
	...
	public static void main(String[] args) throws Exception {
		...
		sender.send("monica.romero2@alu.uclm.es", "Hola", "Caracola");
